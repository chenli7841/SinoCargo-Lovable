...
export const products: Product[] = [
  // === Personal purchases (B2C retail) ===
  {
    ...
    priceCNY: 399, weightKg: 0.15, category: "electronics", image: "🎧", badge: { zh: "热卖", en: "Hot" },
  ...
  },
  {
    ...
    priceCNY: 1488, weightKg: 0.25, category: "electronics", image: "⌚",
    purchaseType: "personal",
  },
  {
    ...
    priceCNY: 89, weightKg: 0.05, category: "beauty", image: "💋", badge: { zh: "新品", en: "New" },
    purchaseType: "personal",
  },
  {
    ...
    priceCNY: 599, weightKg: 0.4, category: "fashion", image: "🧥",
    purchaseType: "personal",
  },
  {
    ...
    priceCNY: 138, weightKg: 1.8, category: "food", image: "🍲", badge: { zh: "包邮", en: "Free ship" },
    purchaseType: "personal",
  },
  {
    ...
    priceCNY: 268, weightKg: 2.5, category: "home", image: "📦",
    purchaseType: "personal",
  },
  {
    ...
    priceCNY: 198, weightKg: 2.2, category: "mom-baby", image: "👶",
    purchaseType: "personal",
  },
  {
    ...
    priceCNY: 79, weightKg: 0.1, category: "health", image: "💊",
    purchaseType: "personal",
  },
  ...
  // === Business purchases (B2B wholesale) ===
  {
    ...
    description: { zh: "深圳工厂直供，支持贴牌与定制包装", en: "Shenzhen factory direct, OEM branding & custom packaging" },
    priceCNY: 58, weightKg: 0.45, category: "electronics", image: "🔊", badge: { zh: "批发", en: "Wholesale" },
    purchaseType: "business", moq: 100,
  ...
  },
  {
    ...
    priceCNY: 22, weightKg: 0.22, category: "fashion", image: "👕",
    purchaseType: "business", moq: 200,
  ...
  },
  {
    ...
    priceCNY: 380, weightKg: 12, category: "home", image: "📮", badge: { zh: "工厂直发", en: "Factory" },
    purchaseType: "business", moq: 1000,
  ...
  },
  {
    ...
    priceCNY: 14, weightKg: 0.08, category: "electronics", image: "💡",
    purchaseType: "business", moq: 500,
...
export const shipments: Record<string, Shipment> = {
  SC2026000123: {
    ...
    eta: "2026-06-25",
    events: [
      { time: "2026-06-18 09:12", location: { zh: "加拿大 多伦多", en: "Toronto, CA" }, status: { zh: "派送中 — 司机已出库", en: "Out for delivery" } },
      { time: "2026-06-17 21:40", location: { zh: "加拿大 多伦多分拨中心", en: "Toronto sort facility" }, status: { zh: "清关完成，已交本地快递", en: "Cleared customs, handed to last-mile" } },
      { time: "2026-06-16 03:05", location: { zh: "加拿大 多伦多机场", en: "Toronto Pearson Airport" }, status: { zh: "到港，等待清关", en: "Arrived, awaiting clearance" } },
      { time: "2026-06-15 14:30", location: { zh: "中国 广州白云机场", en: "Guangzhou Baiyun Airport" }, status: { zh: "国际航班起飞", en: "International flight departed" } },
      { time: "2026-06-14 11:00", location: { zh: "中国 广州集运仓", en: "Guangzhou warehouse" }, status: { zh: "已合箱出库", en: "Consolidated & shipped out" } },
      { time: "2026-06-12 16:22", location: { zh: "中国 广州集运仓", en: "Guangzhou warehouse" }, status: { zh: "包裹入库，正在打包", en: "Package received, repacking" } },
      { time: "2026-06-10 10:00", location: { zh: "线上", en: "Online" }, status: { zh: "订单已创建", en: "Order placed" } },
    ],
  },
};
